      ...
      <div className="glass-card flex flex-col items-center gap-3 rounded-3xl p-4">
        ...
        <div className="relative ludo-root">
          <div className="ludo">
            <div className="blue">
              <div className="box">
                <div className="insidebox blueBackground" />
                <div className="insidebox blueBackground" />
                <div className="insidebox blueBackground" />
                <div className="insidebox blueBackground" />
              </div>
            ...
            <div className="squareContainer">
              ...
              <div className="middle">
                <div className="square redFont">↓</div>
                <div className="square redBackground" />
                <div className="square redBackground" />
                <div className="square redBackground" />
                <div className="square redBackground" />
                <div className="square redBackground" />
            ...
            <div className="red">
              <div className="box">
                <div className="insidebox redBackground" />
                <div className="insidebox redBackground" />
                <div className="insidebox redBackground" />
                <div className="insidebox redBackground" />
              </div>
            ...
            <div className="row">
              <div className="Rowleft">
                <div className="row1">
                  <div className="square" />
                  <div className="square blueBackground" />
                  <div className="square" />
                  <div className="square" />
                  <div className="square" />
                  <div className="square" />
                ...
                <div className="row1">
                  <div className="square blueFont">→</div>
                  <div className="square blueBackground" />
                  <div className="square blueBackground" />
                  <div className="square blueBackground" />
                  <div className="square blueBackground" />
              ...
              <div className="rowright">
                ...
                <div className="row1">
                  <div className="square greenBackground" />
                  <div className="square greenBackground" />
                  <div className="square greenBackground" />
                  <div className="square greenBackground" />
                  <div className="square greenBackground" />
                  <div className="square greenFont">←</div>
                </div>
                <div className="row1">
                  <div className="square" />
                  <div className="square" />
            ...
            <div className="yellow">
              <div className="box">
                <div className="insidebox yellowBackground" />
                <div className="insidebox yellowBackground" />
                <div className="insidebox yellowBackground" />
                <div className="insidebox yellowBackground" />
              </div>
            ...
            <div className="squareContainer">
              <div className="left">
                ...
                <div className="square" />
                <div className="square" />
                <div className="square yellowBackground" />
                <div className="square" />
              </div>
              <div className="middle">
                <div className="square yellowBackground" />
                ...
                <div className="square yellowBackground" />
                <div className="square yellowBackground" />
                <div className="square yellowFont">↑</div>
              </div>
              <div className="right">
                <div className="square" />
                <div className="square" />
            ...
            <div className="green">
              <div className="box">
                <div className="insidebox greenBackground" />
                <div className="insidebox greenBackground" />
                <div className="insidebox greenBackground" />
                <div className="insidebox greenBackground" />
              </div>
                  ...
                  >
                    <div className="flex gap-0.5">
                      {occ.map(({ playerId, tokenIndex }) => {
                        ...
                        const disabled = phase !== "rolled" || dice == null || winner !== null || !isCurrent || isRolling;
