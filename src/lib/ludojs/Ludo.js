...
export class Ludo {
    ...
    onDiceClick() {
        ...
        // Slightly bias rolls towards 6 to make the game feel more dynamic.
        // We roll 1–8; if we hit 7 or 8, treat it as a 6.
        const raw = 1 + Math.floor(Math.random() * 8);
        this.diceValue = raw >= 7 ? 6 : raw;
    ...
    checkForEligiblePieces() {
        ...
        if(eligiblePieces.length) {
            ...
            // No valid moves for this player with the current dice roll.
            // For now we just auto-pass the turn without a popup.
            this.incrementTurn();
        }
    }
    ...
    onPieceClick(event) {
        ...
        const player = target.getAttribute('data-player-id');
